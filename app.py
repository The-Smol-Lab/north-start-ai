...
CURRENCY_CONFIG = {
    "THB": {
        "symbol": "฿",
        "name": "Thai Baht",
        "food_name": "ข้าวผัดกระเพรา (Pad Krapao)",
        "food_price": 60,
        "defaults": {
...
TRANS = {
    "EN": {
        ...
        "api_error": "⚠️ System Error: OPENROUTER_API_KEY not found in environment.",
        "chat_placeholder": "Type your answer here...",
        "chat_welcome": "Hello! 👋 I am your Personal Retirement Coach. \n\nInstead of forms, let's just chat. \n\n**To start, how old are you and when would you like to retire?**",
        "dashboard_btn": "🚀 View My Financial Plan",
        "restart_btn": "Start New Chat",
        "tip_blue_header": "💡 Asset Selection",
        ...
        "tip_green_header": "🍔 Inflation Reality",
        ...
        "tip_yellow_header": "⚡ The Rule of 72",
        ...
        "expense": "Target Monthly Expense", "calc_header": "📊 Your Financial Outlook",
        ...
        "advice_btn": "💡 Ask Coach for Advice",
        "advice_header": "💬 Career & Investment Strategy",
        ...
        "chat_again_btn": "💬 Back to Main Chat",
        ...
        "fine_tune": "🛠️ Fine-tune Assumptions",
        "chart_title": "📈 Wealth Trajectory",
        "metric_safe": "Safe Monthly Income",
        "metric_target": "Target Need",
        "status_success": "🎉 Freedom Achieved!",
        "status_warning": "⚠️ Almost there. Increase savings slightly.",
        "status_danger": "🚨 Action Required. Large gap detected.",
        "quick_fixes": "💡 Quick Fixes",
        "fix_save": "➕ Save +{symbol}{amount}/mo",
        "fix_delay": "⏳ Retire +2 Years",
    ...
    "TH": {
        "title": "มาวางแผนเกษียณกัน!",
        "api_error": "⚠️ ข้อผิดพลาดระบบ: ไม่พบ OPENROUTER_API_KEY ใน Environment",
        "chat_placeholder": "พิมพ์คำตอบที่นี่...",
        "chat_welcome": "สวัสดีครับ! 🙏 ผมคือโค้ชการเงินส่วนตัวของคุณ \n\nไม่ต้องกรอกฟอร์มให้ยุ่งยาก แค่เล่าเรื่องของคุณให้ผมฟัง\n\n**เริ่มจาก... ตอนนี้คุณอายุเท่าไหร่ และอยากเกษียณตอนอายุเท่าไหร่ครับ?**",
        "dashboard_btn": "🚀 ดูแผนการเงินของฉัน",
        "restart_btn": "เริ่มคุยใหม่",
        "tip_blue_header": "💡 ที่เก็บเงินสำคัญไฉน?",
        "tip_blue_body": "ฝากธนาคารอาจได้ดอกเบี้ย **{cash_rate}%** แต่ถ้าลงทุนหุ้นอาจได้ **{stock_rate}%** ระบบจะช่วยประเมินผลตอบแทนตามสไตล์การออมของคุณครับ",
        "tip_green_header": "🍛 เรื่องจริงของเงินเฟ้อ",
        "tip_green_body": "รู้ไหมครับ **{food_name}** ราคา **{symbol}{price}** วันนี้ ในอีก 20 ปีข้างหน้าอาจพุ่งไปถึง **{symbol}{future_price}**!",
        "tip_yellow_header": "⚡ กฎเลข 72",
        "tip_yellow_body": "อยากให้เงินงอกเงยเป็น 2 เท่าต้องใช้เวลากี่ปี? เอา 72 หารด้วยผลตอบแทน ถ้าได้ **7%** เงินจะโต 2 เท่าใน **~10 ปี** เริ่มเร็วได้เปรียบ!",
        "age": "อายุปัจจุบัน", "retire_age": "เกษียณตอนอายุ", "curr_sav": "เงินออมปัจจุบัน",
        "month_sav": "เงินออมต่อเดือน", "return_rate": "ผลตอบแทน (%)", 
        "inflation": "เงินเฟ้อ (%)", "growth": "เงินออมโตปีละ (%)",
        "expense": "รายจ่ายหลังเกษียณต่อเดือน", "calc_header": "📊 ภาพรวมทางการเงินของคุณ",
        "krapao_label": "ดัชนี {food_name} (ในอนาคต)",
        "krapao_help": "ราคา {food_name} 1 จาน ในวันที่คุณเกษียณ (คำนวณจากเงินเฟ้อ)",
        "rate_source": "ปรับผลตอบแทนเป็น {rate}% ตามรูปแบบการออม: '{style}'",
        "advice_btn": "💡 ปรึกษาโค้ชเพิ่มเติม",
        "advice_header": "💬 คำแนะนำอาชีพและการลงทุน",
        "advice_intro": "ผมช่วยแนะนำวิธีไปถึงเป้าหมายได้ครับ เพื่อความแม่นยำ **ช่วยบอกหน่อยครับว่าทำอาชีพอะไร?**",
        "advice_placeholder": "เช่น เป็นพนักงานบริษัทเอกชน...",
        "chat_again_btn": "💬 กลับไปคุยกับโค้ชหลัก",
        "download_btn": "📥 ดาวน์โหลดรายงานฉบับเต็ม",
        "sidebar_settings": "ตั้งค่า",
        "sidebar_profile": "ความสมบูรณ์ของข้อมูล",
        "sidebar_keep_going": "คุยต่อนะครับ กราฟใกล้เต็มแล้ว!",
        "sidebar_summary": "ข้อมูลปัจจุบัน",
        "fine_tune": "🛠️ ปรับตัวแปรสมมติฐาน",
        "chart_title": "📈 เส้นทางสู่ความมั่งคั่ง",
        "metric_safe": "รายได้ที่ใช้ได้จริง (ต่อเดือน)",
        "metric_target": "เป้าหมายรายจ่าย",
        "status_success": "🎉 ยินดีด้วย! คุณมีอิสรภาพทางการเงินแล้ว",
        "status_warning": "⚠️ เกือบถึงแล้ว! ลองออมเพิ่มอีกนิด",
        "status_danger": "🚨 ต้องรีบปรับแผน! ช่องว่างยังห่างอยู่",
        "quick_fixes": "💡 ทางลัดแก้เกม",
        "fix_save": "➕ ออมเพิ่ม {amount}",
        "fix_delay": "⏳ เกษียณช้าลง 2 ปี",
        "footer_gen": "สร้างโดย AI วางแผนเกษียณ",
        "rep_age": "อายุปัจจุบัน",
        "rep_retire_age": "อายุเกษียณ",
        "rep_curr_sav": "เงินออมปัจจุบัน",
        "rep_month_sav": "เงินออมต่อเดือน",
        "rep_exp_ret": "ผลตอบแทนคาดหวัง",
        "rep_inflation": "อัตราเงินเฟ้อ",
        "rep_sav_growth": "การเติบโตเงินออม",
        "rep_safe_inc": "รายได้ที่ใช้ได้จริง",
        "rep_target_exp": "รายจ่ายเป้าหมาย",
        "rep_score": "คะแนนความพร้อม",
        "rep_krapao": "ราคา {food_name} ในอนาคต",
        "rep_no_advice": "ยังไม่มีการขอคำแนะนำเพิ่มเติม",
        "rep_coach_you": "คุณ",
        "rep_coach_ai": "โค้ช",
        "rep_inv_style": "รูปแบบการลงทุน",
        "sel_asset": "สินทรัพย์ที่ลงทุน",
        "nav_header": "เมนูหลัก",
        "nav_chat": "📝 สัมภาษณ์",
        "nav_dash": "📊 ผลวิเคราะห์"
    }
}
...
def generate_html_report(profile, assumptions, safe_income, target_expense, food_price, score, advice_history, fig, lang, currency):
    ...
    t_header = "Financial Freedom Report" if lang == "EN" else "รายงานแผนเกษียณอายุ"
    t_date = "Date Generated" if lang == "EN" else "วันที่สร้างรายงาน"
    t_profile = "Profile Summary" if lang == "EN" else "ข้อมูลส่วนตัว"
    t_assumptions = "Assumptions" if lang == "EN" else "สมมติฐานการคำนวณ"
    t_metrics = "Key Metrics" if lang == "EN" else "ตัวเลขสำคัญ"
    t_advice = "Coach Suggestions" if lang == "EN" else "คำแนะนำจากโค้ช"
    t_chart = "Wealth Projection" if lang == "EN" else "กราฟแสดงความมั่งคั่ง"
...
st.set_page_config(page_title="North Star", page_icon="✴️", layout="wide")
...
with st.sidebar:
    ...
    if st.button(f"✨ {t['restart_btn']}", type="primary", use_container_width=True):
